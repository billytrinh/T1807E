function checkForm() {
	...
	var phone = document.forms["form-register"].phone.value;
	var password = document.forms["form-register"].password.value;
	var passwordre = document.forms["form-register"].passwordre.value;
	var code = document.forms["form-register"].code.value;
