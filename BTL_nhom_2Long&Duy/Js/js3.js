var html = '';
		for (var i = 0; i < products3.length; i++) 
		{
				...
				html+='				<img src="'+products3[i].image+'"/>';
				html+='				<figcaption>'+products3[i].name+'</figcaption>';
				html+='			</figure>';
				html+='			<p class="price-box"><span class="price"> '+products3[i].price+' </span></p>';
...
document.getElementById("product_list_3").innerHTML = html;