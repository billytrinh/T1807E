...
function get_product_view2(products,itemnumber,productlist)
{
	var html = '';
	for (var i = 0; i < products.length; i++) {
		html+='<div class="item col-lg-4">';
		html+='	<div class="item-content carousel-inner">';
		html+='	<figure>';
		html+='		<img width=auto height=190px src="'+products[i].image+'"/>';
		html+='		<figcaption>'+products[i].name+'</figcaption>';
		html+='	</figure>';
		html+='		<p class="price-box"><span class="price">'+products[i].price+'</span></p>';
		html+='<div class="size">';
