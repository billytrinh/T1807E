...
var html = '';
		for (var i = 0; i < products.length; i++) {
			...
			html +=						'<img width="14px" height="13px" src="'+products[i].sizeicon1+'"/>';
			html +=						'<img width="14px" height="13px" src="'+products[i].sizeicon2+'"/>';
			html +=						'<img width="14px" height="13px" src="'+products[i].sizeicon3+'"/>';
			html +=						'<img width="14px" height="13px" src="'+products[i].sizeicon4+'"/>';
			html +=					'</div>';
